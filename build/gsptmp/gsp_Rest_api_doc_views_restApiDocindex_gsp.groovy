...
class gsp_Rest_api_doc_views_restApiDocindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/views/restApiDoc/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',10,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("layout"),'content':(layout)],-1)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1521395812000L
